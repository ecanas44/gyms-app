...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    durationDaysOptional: "Duration days (optional)",
    durationDays: "Duration days",
    includedPunchesOptional: "Included punches (optional)",
    includedPunches: "Included punches",
    planDescriptionOptional: "Plan description (optional)",
    planTypeMonthly: "Monthly",
    planTypePunchCard: "Punch card",
    planTypeDayPass: "Day pass",
    planTypeAnnual: "Annual",
    planTypeBimonthly: "Bimonthly",
    planTypeCustom: "Custom",
    planTypeLabelOptional: "Plan type label (optional)",
    active: "Active",
    inactive: "Inactive",
    saving: "Saving...",
    addType: "Add type",
    ...
    durationMustBeNonNegativeInteger: "Duration days must be a non-negative integer",
    punchesMustBeNonNegativeInteger: "Included punches must be a non-negative integer",
  ...
  es: {
    ...
    durationDaysOptional: "Duración en días (opcional)",
    durationDays: "Duración en días",
    includedPunchesOptional: "Entradas incluidas (opcional)",
    includedPunches: "Entradas incluidas",
    planDescriptionOptional: "Descripción del plan (opcional)",
    planTypeMonthly: "Mensual",
    planTypePunchCard: "Tarjeta de entradas",
    planTypeDayPass: "Pase diario",
    planTypeAnnual: "Anual",
    planTypeBimonthly: "Bimensual",
    planTypeCustom: "Personalizado",
    planTypeLabelOptional: "Etiqueta del tipo de plan (opcional)",
    active: "Activo",
    inactive: "Inactivo",
    saving: "Guardando...",
    ...
    durationMustBeNonNegativeInteger: "La duración debe ser un número entero no negativo",
    punchesMustBeNonNegativeInteger: "Las entradas incluidas deben ser un entero no negativo",
